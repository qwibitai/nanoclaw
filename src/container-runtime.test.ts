...
describe('stopContainerArgs', () => {
  it('returns binary and args array (no shell interpolation)', () => {
...
describe('cleanupOrphans', () => {
  it('stops orphaned nanoclaw containers using execFileSync', () => {
    ...
    // ps via execSync
    expect(mockExecSync).toHaveBeenCalledTimes(1);
    // 2 stop calls via execFileSync (no shell interpolation)
