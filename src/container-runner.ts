...
function buildVolumeMounts(
  ...
  if (isMain) {
    ...
    // .env shadowing is handled by the container entrypoint via mount --bind.
    // Apple Container only supports directory mounts, so the host-side /dev/null
    // overlay that Docker supported doesn't work here.
