...
export class StatusTracker {
  ...
  private enqueueSend(msg: TrackedMessage, emoji: string): void {
    // Skip reaction-based status for the main group (1-on-1 DM).
    // Typing indicators are more natural in DMs; reactions feel spammy.
    if (this.deps.isMainGroup(msg.chatJid)) return;
