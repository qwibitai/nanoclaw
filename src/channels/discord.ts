...
export class DiscordChannel implements Channel {
  ...
  async connect(): Promise<void> {
    ...
    this.client.on(Events.MessageCreate, async (message: Message) => {
      ...
      // Handle slash commands (text-based, not Discord Application Commands)
      const knownCommands = ['/status', '/new', '/tasks'];
      ...
      if (knownCommands.includes(firstWord) && this.opts.onSlashCommand) {
        ...
        const reply = await this.opts.onSlashCommand(chatJid, firstWord);
