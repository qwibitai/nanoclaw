...
describe('WhatsAppChannel', () => {
  ...
  describe('connection lifecycle', () => {
    ...
    it('runtime smoke: connects and responds to an inbound DM', async () => {
      ...
      channel = new WhatsAppChannel({
        ...
        onMessage: (chatJid, msg) => {
          void channel.sendMessage(chatJid, `Ack: ${msg.content}`);
        },
      });
      ...
      await triggerMessages([
        {
          ...
          message: { conversation: 'hello from Adam' },
          pushName: 'Adam',
        },
      ]);
