...
// Baileys requires ILogger with level/child/trace. Wrap our minimal logger.
const baileysLogger = {
  ...logger,
  level: 'silent',
  trace: (dataOrMsg: Record<string, unknown> | string, msg?: string) => logger.debug(dataOrMsg as Record<string, unknown>, msg),
  child: () => baileysLogger,
};
