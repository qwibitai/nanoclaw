...
describe('markdownToTelegramHtml', () => {
  ...
  it('converts ~~strikethrough~~ to <s>', () => {
    expect(markdownToTelegramHtml('this is ~~removed~~ text')).toBe(
      'this is <s>removed</s> text',
    );
  });
  ...
  it('converts markdown headings to bold', () => {
    expect(markdownToTelegramHtml('## Section Title')).toBe(
      '<b>Section Title</b>',
    );
  });
  ...
  it('preserves existing Telegram HTML tags', () => {
    expect(markdownToTelegramHtml('already <b>bold</b> text')).toBe(
      'already <b>bold</b> text',
    );
  });
  ...
  it('handles complex mixed content', () => {
    ...
    const expected =
      '<b>Title</b>\n\nSome <b>bold</b> and <i>italic</i> with <code>code</code>';
