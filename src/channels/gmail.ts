...
// Gmail is configured as tool-only (MCP inside the container).
// Channel registration is disabled to prevent inbox polling.
// To enable channel mode, uncomment the block below.
//
