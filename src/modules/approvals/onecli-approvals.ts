...
const _onecliEnv = readEnvFile(['ONECLI_URL', 'ONECLI_API_KEY']);
const ONECLI_URL = process.env.ONECLI_URL || _onecliEnv.ONECLI_URL;
const ONECLI_API_KEY = process.env.ONECLI_API_KEY || _onecliEnv.ONECLI_API_KEY;
