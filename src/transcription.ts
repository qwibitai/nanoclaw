 ...
 * Channel-agnostic — accepts a raw Buffer regardless of source.
 * Requires ffmpeg and whisper-cli (from whisper.cpp) to be installed.
 */
...
/**
 * Downloads and transcribes a WhatsApp voice message.
 * Uses transcribeAudioBuffer internally after downloading via Baileys.
 */
