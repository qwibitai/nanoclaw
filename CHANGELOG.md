...
- Stale credential files are removed from group `.claude/` before container launch with TOCTOU-safe error handling
- SSRF protection documented in CLAUDE.md safety features
