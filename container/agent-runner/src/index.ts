...
async function runQuery(
  ...
  ipcPolling = false;
  log(
    `Query done. Messages: ${messageCount}, results: ${resultCount}, inputTokens: ${totalInputTokens}, outputTokens: ${totalOutputTokens}, cacheRead: ${totalCacheReadInputTokens}, cacheCreation: ${totalCacheCreationInputTokens}, lastAssistantUuid: ${lastAssistantUuid || 'none'}, closedDuringQuery: ${closedDuringQuery}`,
  );
  return {
    newSessionId,
    lastAssistantUuid,
  ...
  try {
    while (true) {
      ...
      sessionCacheCreationInputTokens +=
        queryResult.totalCacheCreationInputTokens;
      ...
      writeOutput({
        ...
        cacheReadInputTokens: sessionCacheReadInputTokens,
        cacheCreationInputTokens: sessionCacheCreationInputTokens,
      });
