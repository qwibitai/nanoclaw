...
const chatJid = process.env.CODECLAW_CHAT_JID!;
const groupFolder = process.env.CODECLAW_GROUP_FOLDER!;
const isMain = process.env.CODECLAW_IS_MAIN === '1';
