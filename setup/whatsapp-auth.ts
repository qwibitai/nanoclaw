...
<html><head><title>CamBot-Agent - WhatsApp Auth</title>
...
<script>
  var startKey = 'cambot-agent_qr_start';
...
<html><head><title>CamBot-Agent - Connected!</title>
<style>
...
<script>localStorage.removeItem('cambot-agent_qr_start');</script>
</body></html>`;
