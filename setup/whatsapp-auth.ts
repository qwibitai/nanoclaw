...
<html><head><title>CodeClaw - WhatsApp Auth</title>
...
<script>
  var startKey = 'codeclaw_qr_start';
...
<html><head><title>CodeClaw - Connected!</title>
<style>
...
<script>localStorage.removeItem('codeclaw_qr_start');</script>
</body></html>`;
