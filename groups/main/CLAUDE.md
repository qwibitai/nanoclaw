...
Project management has moved to the dedicated Projects groups:
- *Telegram*: Projects TG (`tg:-5232959204`)
- *Discord*: #projects (`dc:1477713227440984144`)

If Joe asks about project work here, remind him to use the Projects channel, or forward the request there via `mcp__nanoclaw__send_message`.
