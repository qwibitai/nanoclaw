...
| Workflow setup mode / review policy ownership changes | `docs/workflow/github/nanoclaw-github-control-plane.md`, `docs/operations/workflow-setup-responsibility-map.md`, `docs/operations/roles-classification.md`, relevant `.github/workflows/*` |
| User-review handoff/readiness gate changes | `docs/workflow/github/nanoclaw-github-control-plane.md`, `docs/operations/roles-classification.md`, `groups/andy-developer/docs/review-handoff.md`, `container/rules/andy-developer-operating-rule.md` |
