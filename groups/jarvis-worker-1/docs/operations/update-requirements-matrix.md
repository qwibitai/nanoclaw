...
| User-review handoff/readiness gate changes | `docs/workflow/github/github-delivery-governance.md`, `docs/operations/roles-classification.md`, `groups/andy-developer/docs/review-handoff.md`, `container/rules/andy-developer-operating-rule.md` |
