...
- **Multi-channel messaging** - Talk to your assistant from WhatsApp, Telegram, Discord, Slack, Gmail, or Google Chat. Add channels with skills like `/add-whatsapp` or `/add-telegram`. Run one or many at the same time.
