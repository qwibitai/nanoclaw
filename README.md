...
- **Messenger I/O** - Message NanoClaw from your phone. Supports Telegram, with additional channels available via skills.
...
For example, if you want to add Discord support, contribute a skill file (`.claude/skills/add-discord/SKILL.md`) that teaches Claude Code how to transform a NanoClaw installation to use Discord.
