...
- **Web access** - Search and fetch content from the Web, plus optional Tavily-powered search, extraction, crawling, and research in runtime containers when `TAVILY_API_KEY` is configured
