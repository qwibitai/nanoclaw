...
This skill adds a stdio-based MCP server that exposes local Ollama models as tools for the container agent. Codex remains the orchestrator but can offload work to local models, and can optionally manage the model library directly.
