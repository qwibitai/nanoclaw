...
| `src/core/types.ts` | TypeScript interfaces (includes Channel) |
| `src/core/config.ts` | Assistant name, trigger pattern, directories |
| `src/storage/db.ts` | Database initialization and queries |
