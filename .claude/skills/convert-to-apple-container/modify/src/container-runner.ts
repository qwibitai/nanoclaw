...
function buildVolumeMounts(
  ...
  if (isMain) {
    ...
    // mount --bind /dev/null .env (Apple Container / VirtioFS only
    // supports directory mounts, not file mounts from the host).
...
function buildContainerArgs(
  ...
  // Apple Container handles host.docker.internal natively — no
  // --add-host=host.docker.internal:host-gateway needed.
