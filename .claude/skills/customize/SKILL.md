...
### Adding a New Input Channel (e.g., Telegram, Slack)

Questions to ask:

- Which channel? (Telegram, Slack, etc.)
...
1. Find/add MCP server for the channel or library
...
2. Ask: "Should Telegram messages create separate conversation contexts, or share with Discord groups?"
3. Find Telegram library
