---
name: add-pdf-reader
description: Add PDF reading to Argus agents. Extracts text from PDFs via pdftotext CLI. Handles WhatsApp attachments, URLs, and local files.
---
...
```bash
tail -f logs/argus.log | grep -i pdf
```
