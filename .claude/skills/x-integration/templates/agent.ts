...
Make sure the content is appropriate and within X's character limit (${TWEET_MAX_LENGTH} chars for text).`,
      ...
      async (args: { content: string }) => {
        ...
        return invokeHost('post', { content: args.content });
      }
    ),
...
Provide the tweet URL and your reply content.`,
      ...
      async (args: { tweet_url: string; content: string }) => {
        ...
        return invokeHost('reply', { tweetUrl: args.tweet_url, content: args.content });
      }
    ),
...
Retweet with your own comment added.`,
      ...
      async (args: { tweet_url: string; comment: string }) => {
        ...
        return invokeHost('quote', { tweetUrl: args.tweet_url, comment: args.comment });
      }
    ),
  ];
}
