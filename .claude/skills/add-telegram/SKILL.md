...
This skill adds Telegram support to Argus, then walks through interactive setup.
...
```bash
git remote add telegram https://github.com/qwibitai/argus-telegram.git
```
...
- Check bot is started: `tail -f logs/argus.log`
