...
AskUserQuestion: What trigger word? (default: Flux). In group chats, messages starting with @TriggerWord go to Claude. In the main channel, no prefix needed.
...
- `--assistant-name "Name"` — if trigger word differs from "Flux"
