---
name: sdk-reference
description: Claude Agent SDK internals reference. Use when modifying container-runner.ts, agent-runner, or debugging SDK behavior (session resume, query options, streaming, hooks, tool execution).
---
