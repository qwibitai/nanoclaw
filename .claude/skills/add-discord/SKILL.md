---
name: add-discord
description: Add Discord as a channel. Can replace WhatsApp entirely or run alongside it. Supports text messages, @mention triggers, reply context, and message splitting.
---
