---
name: add-discord
description: Add Discord bot channel integration to Argus.
---

# Add Discord Channel

This skill adds Discord support to Argus, then walks through interactive setup.
...
```bash
git remote add discord https://github.com/qwibitai/argus-discord.git
```
...
4. Service is running: `launchctl list | grep argus`
...
- @mention translation (Discord `<@botId>` → Argus trigger format)
