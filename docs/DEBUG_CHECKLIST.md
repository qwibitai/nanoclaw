...
> Historical note: parts of this checklist still describe older container-based debugging paths. For the current tmux runtime, start with [SETUP_RECOVERY.md](SETUP_RECOVERY.md) and `npm run smoke:runtime` plus `npm run smoke:health`.
