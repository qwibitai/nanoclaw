...
A personal Claude assistant with multi-channel support, persistent memory per conversation, scheduled tasks, and a pluggable agent runtime.

> Current implementation note: the shipping runtime is tmux host execution. Container and micro-VM references below should be treated as historical design intent unless they are explicitly called out as future work.
