...
| Container Runtime | Docker | Isolated Linux VMs for agent execution |
...
1. **Ensures Docker system is running** - Automatically starts it if needed (survives reboots)
...
| "Claude Code process exited with code 1" | Docker not running | Check logs; ensure Docker is running |
