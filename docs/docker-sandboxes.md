...
> Historical / experimental runtime note: this guide does not describe the current default NanoClaw runtime. The main repo now ships tmux host execution by default. Keep this document as reference material for downstream or future isolated-runtime work.
