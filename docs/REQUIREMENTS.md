...
- `/add-whatsapp` - Re-add WhatsApp support
...
- Using discord.js library for Discord connection
...
- `/setup` - Install dependencies, authenticate (Discord Token), configure scheduler, start services
...
- **Main channel**: Self-chat (DM or private channel in Discord)
