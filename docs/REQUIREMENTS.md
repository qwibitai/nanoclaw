...
CamBot-Agent gives you the core functionality without that mess.
...
- Custom `cambot-agent` MCP server (inside container) provides scheduling tools
...
**CamBot-Agent** - A reference to Clawdbot (now OpenClaw).
