...
### Container Runtime
The project uses any Docker-compatible runtime by default (cross-platform) — Docker Desktop, Colima, OrbStack, etc. For macOS users who prefer Apple Container:
