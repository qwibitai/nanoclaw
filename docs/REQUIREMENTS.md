...
Sovereign gives you the core functionality without that mess.
...
- Custom `sovereign` MCP server (inside container) provides scheduling tools
...
**Sovereign** — forked from NanoClaw (originally Clawdbot, now OpenClaw).
