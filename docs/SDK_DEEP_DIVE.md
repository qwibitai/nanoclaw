...
| `betas`                           | `SdkBeta[]`                                                            | `[]`                    | Beta features. Claude Code also supports the `[1m]` model suffix for supported long-context models. |
...
// Older API beta for long context. Claude Code model strings can use
// `[1m]` directly for supported models such as Opus 4.7 and Sonnet 4.6.
```
