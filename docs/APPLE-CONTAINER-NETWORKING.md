...
> Historical / experimental runtime note: Apple Container is not the current default NanoClaw runtime. This document remains useful only for downstream or future isolated-runtime work.
