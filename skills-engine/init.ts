...
import { BACKUP_DIR, BASE_DIR, BASE_INCLUDES, CODECLAW_DIR } from './constants.js';
...
export function initCodeclawDir(): void {
  const projectRoot = process.cwd();
  const codeclawDir = path.join(projectRoot, CODECLAW_DIR);
