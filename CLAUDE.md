...
This project is indexed by GitNexus as **nanoclaw** (1240 symbols, 3345 relationships, 98 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
